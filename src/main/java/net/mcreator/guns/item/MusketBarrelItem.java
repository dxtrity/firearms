...
public class MusketBarrelItem extends GunsModElements.ModElement {
	@ObjectHolder("guns:musket_barrel")
	public static final Item block = null;
	public MusketBarrelItem(GunsModElements instance) {
		super(instance, 3);
	}
